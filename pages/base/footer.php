                ...
                <div class="col" style="--w-md: 4">
                    <div class="footer__block pd-top">
                        ...
                        <ul class="block__list">
                            ...
                            ?>
                                <li class="block__item"><a class="footer__anchor"
                                        href="index.php?page=product_category&category_id=<?php echo $row_category['category_id'] ?>"><?php echo $row_category['category_name'] ?></a>
                                </li>
                            <?php
                            }
                            ?>
                ...
                <div class="col" style="--w-md: 4">
                    <div class="footer__block pd-top">
                        <div class="footer__logo">
                            <img src="assets/images/logo/laptopsale-logo.png" alt="logo" style="width:250px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col pd-top" style="--w-md: 4;">
                    <div class="footer__subscribe">
                        <h3 class="block__heading text-center">
                            Nhập vào email của bạn để theo dõi H Shop
                        </h3>
                ...
                <div class="col pd-top d-flex align-center" style="--w-md:4;">
                    <ul class="social__items d-flex align-center">
                        ...
                        <li class="social__item">
                            <a class="" href="https://www.facebook.com/nhhao03?mibextid=LQQJ4d">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <p class="footer__copy--right">© 2025 by Admin</p>
                    </div>
                </div>
            </div>
        </div>
