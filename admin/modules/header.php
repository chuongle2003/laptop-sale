    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="index.php?action=home&query">
                <!-- <img src="https://hanoicomputercdn.com/media/lib/15-07-2024/logo-hacom-since-2001.png" alt="logo" /> -->
                <!-- <img src="admin\images\logo-shop.jpg" alt="logo" style="width:250px;"> -->
